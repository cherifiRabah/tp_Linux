cmd_/home/cherifi/rpi-kernel/tools/objtool/check.o := gcc -Wp,-MD,/home/cherifi/rpi-kernel/tools/objtool/.check.o.d -Wp,-MT,/home/cherifi/rpi-kernel/tools/objtool/check.o -Wall -Werror -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wshadow -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wno-switch-default -Wno-switch-enum -Wno-packed -fomit-frame-pointer -O2 -g -I/home/cherifi/rpi-kernel/tools/include -I/home/cherifi/rpi-kernel/tools/arch/x86/include/uapi -I/home/cherifi/rpi-kernel/tools/objtool/arch/x86/include -I/home/cherifi/rpi-kernel/tools/lib -D"BUILD_STR(s)=$(pound)s" -c -o /home/cherifi/rpi-kernel/tools/objtool/check.o check.c

source_/home/cherifi/rpi-kernel/tools/objtool/check.o := check.c

deps_/home/cherifi/rpi-kernel/tools/objtool/check.o := \
...
/home/cherifi/rpi-kernel/tools/objtool/check.o: $(deps_/home/cherifi/rpi-kernel/tools/objtool/check.o)
